...
1 3 6 7 9""".stripMargin
  ...
  "part2Lists" should "work for an example" in {
    val input =
      """7 6 4 2 1
1 2 7 8 9
9 7 6 2 1
...
8 6 4 4 1
1 3 6 7 9""".stripMargin
    new Two().part2Lists(input) shouldEqual List(true, false, false, true, true,
      true)
  }
